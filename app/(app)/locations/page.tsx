...
const copy = {
  es: {
    title: "Locaciones",
    description:
      "Selecciona un proyecto para trabajar sus lugares, coordenadas opcionales y notas espaciales.",
    sectionLabel: "Ruta",
    emptyEyebrow: "PICK",
  ...
  en: {
    title: "Locations",
    description:
      "Select a project to work on its places, optional coordinates, and spatial notes.",
    sectionLabel: "Route",
    emptyEyebrow: "PICK",
