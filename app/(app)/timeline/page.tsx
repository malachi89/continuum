...
const copy = {
  es: {
    ...
    description:
      "Selecciona un proyecto para revisar secuencias, orden temporal y señales de continuidad.",
    sectionLabel: "Ruta",
    emptyEyebrow: "PICK",
  ...
  en: {
    title: "Timeline",
    description:
      "Select a project to review sequences, time order, and continuity signals.",
    sectionLabel: "Route",
    emptyEyebrow: "PICK",
