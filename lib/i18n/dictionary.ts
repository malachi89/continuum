...
export const dictionary = {
  es: {
    ...
    productionDescription: "Controla props, maquillaje, vestuario y peinado por proyecto y escena.",
    saving: "Guardando...",
    projects: "Proyectos",
  ...
  en: {
    ...
    productionDescription: "Manage props, makeup, wardrobe, and hairstyle per project and scene.",
    saving: "Saving...",
    projects: "Projects",
